...
export default function MarketAggregatorDashboard() {
	...
	const [nflCombinedView, setNflCombinedView] = useState<'table' | 'cards'>('table')
	...
	const toggleVisibility = (idx: number, key: 'polymarket' | 'kalshi' | 'sportsbooks') => {
	...
	const fetchOrderbook = async () => {
		...
		try {
			...
			setError(err.message || 'Failed to fetch orderbook history')
		} finally {
